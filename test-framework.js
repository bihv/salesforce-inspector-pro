...
addEventListener("load", () => {
  (async () => {
    try {
      ...
      console.log("Salesforce Inspector Pro unit tests finished successfully");
      window.result.textContent = "Salesforce Inspector Pro unit tests finished successfully";
      window.page.src = "data:text/plain,Salesforce Inspector Pro unit test finished successfully";
    } catch (e) {
